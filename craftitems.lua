...
core.register_craftitem("basic_materials:oil_extract", {
...
core.register_craftitem("basic_materials:terracotta_base", {
	description = S("Uncooked Terracotta Base"),
	inventory_image = "basic_materials_terracotta_base.png",
})

core.register_craftitem("basic_materials:wet_cement", {
...
core.register_craftitem("basic_materials:stainless_steel_wire", {
	description = S("Spool of stainless steel wire"),
	groups = { wire = 1 },
	inventory_image = "basic_materials_stainless_steel_wire.png",
})

core.register_craftitem("basic_materials:aluminum_wire", {
...
core.register_craftitem("basic_materials:brass_ingot", {
...
core.register_craftitem("basic_materials:padlock", {
	description = S("Padlock"),
	inventory_image = "basic_materials_padlock.png",
})

if core.get_modpath("hades_materials") then
	core.register_alias_force("basic_materials:plastic_sheet", "hades_materials:plastic_sheeting")
	core.register_alias_force("basic_materials:paraffin", "hades_materials:plastic_base")
	core.register_alias_force("basic_materials:silicon", "hades_materials:silicon")
end
